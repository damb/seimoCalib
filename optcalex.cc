...
int main(int iargc, char* argv[])
{
  ...
  char notes_text[]=
  {
    ...
    "calex program. The IDs 'amp', 'del', 'sub' or 'til' belong to obligatory
    "system parameters (see below).\n"
    "Besides of usual system parameter there are as well system parameters\n"
    "treated as grid system parameters. Grid system parameters set up the\n"
    "optcalex parameter space.\n"
    ...
    "one.\n"
    "In case of defining system parameters with identical 'nam' ids will\n"
    "enforce optcalex to only take the latter one into account.\n"
